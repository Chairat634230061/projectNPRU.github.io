...
<div class="table-container">
        ...
        <?php
                ...
                // คิวรีข้อมูลจากตาราง unsuccessful โดยใช้ INNER JOIN และเงื่อนไข WHERE เพื่อกรองเฉพาะข้อมูลของผู้ใช้ที่ รหัสนักศึกษา เท่ากับ รหัสนักศึกษา ที่เข้าระบบ
                $stmt = $conn->prepare("SELECT unsuccessful.*, studentuser.* 
                FROM unsuccessful 
                INNER JOIN studentuser ON unsuccessful.studentID = studentuser.studentID 
                WHERE unsuccessful.activity2 IS NOT NULL AND unsuccessful.activity2 != '' 
