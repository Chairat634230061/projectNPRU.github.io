...
if (isset($_POST['Join'])) {
    // รับข้อมูลที่ส่งมาจากแบบฟอร์ม
        ...
        $studygroup = $_POST['studygroup']; // ใช้ข้อมูล studygroup จากเซสชัน
        ...
        $stmt = $conn->prepare("INSERT INTO join_activity (name_activity, firstname, lastname, studentID, studygroup, activity_date1, activity_date2, name_location, mr_ms) VALUES (:name_activity, :firstname, :lastname, :studentID, :studygroup, :activity_date1, :activity_date2, :name_location, :mr_ms)");
