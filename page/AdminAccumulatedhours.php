...
<style>
    .containerID {
    max-height: 380px; /* ปรับความสูงตามต้องการ */
    overflow-x: auto; /* เพิ่มการเลื่อนแนวนอน */
    white-space: nowrap; /* ป้องกันข้อความขยับไปในเซลล์ */
    text-overflow: ellipsis; /* แสดง ... เมื่อข้อความยาวเกินขอบเขตของเซลล์ */
    overflow-y: auto; /* เพิ่มการเลื่อนแนวตั้งเฉพาะ */
}
</style>
...
<body>
    ...
    <?php include '../component/Admin/Accumulatedhours.php'?>
