...
<body>
    <div class="container">
        <div class="left-box">
            <h1 class="npru_h1">เข้าสู่ระบบผู้รับรอง</h1>
            <!-- ส่วนซ้าย -->
            <form action="db-certifier.php" method="post">
                <div class="user-box">
                    <label for="email" >อีเมลผู้รับรอง</label>
            ...
            <div class="user-box">
                <button type="submit" name='LoginCertifier' class="npru-button">เข้าสู่ระบบผู้รับรอง</button>
            </div>
        </form>
    </div>
